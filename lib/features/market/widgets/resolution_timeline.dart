...
/// Market resolution timeline вЂ” shows resolved markets with outcome,
                ...
                : _resolved.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, i) =>
                            _ResolutionRow(market: _resolved[i]),
                      ),
          ),
        ],
      ),
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 6,
            decoration:
                BoxDecoration(color: outcomeColor, shape: BoxShape.circle),
          ),
